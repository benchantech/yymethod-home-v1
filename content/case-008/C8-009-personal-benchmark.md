# C8-009: Personal 1,500-Point Score as Calibrated Benchmark
**Method:** YY Method™ Home Edition v2.3 — Capture → Why → Why-Not → Commit → Timestamp
**Status:** Decided
**Date:** 2026-04-25
**Domain:** Analysis
**Depends On:** C8-008
**Freshness Boundary:** Active. Reverify after the next tournament — the benchmark should be updated to reflect current preparation and execution under the evolved strategy.
...
- Memorizing roughly 50 high-value words — primarily targeting 15-letter constructions in the 540–1,377 point theoretical range under optimal multiplier conditions.
- Studying board geometry to understand how premium square lanes work and how to route long words through them.
- Analyzing tile-combination opportunities: which letters combine to form the highest face-value words, and how to align them with letter bonus squares inside word bonus lanes.
- Applying standard Scrabble vocabulary knowledge throughout — the operator regularly scores 300–400 in standard Scrabble, occasionally exceeding 500 against computer opposition.
...
**Why not treat the personal score as irrelevant to the scoring integrity question?**
...
**Why not update the benchmark based on the revised strategy before making the comparison?**
