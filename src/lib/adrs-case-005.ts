...
export const adrsCase005: ADRCase005[] = [
  ...
  },
  {
    ...
    status: "Decided",
    freshness: "Active",
    freshnessNote: "Active. Reverify if family constraints change materially, the school situation degrades, or a property appears that delivers multiple first-order gains simultaneously.",
    date: "2026-04-11",
    domain: "resolution",
    position: "Derived",
  ...
  },
  {
    ...
    status: "Decided",
    freshness: "Active",
    freshnessNote: "Active. Reverify if a unicorn property appears, if the current home stops working materially, or as the family approaches the next life-phase transition.",
    date: "2026-04-11",
    domain: "resolution",
    position: "Derived",
