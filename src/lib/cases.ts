...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    subtitle: "Real YY · family AI literacy · YY lens · private key/public key · non-coercion",
    date: "2026-06-06",
    status: "In Progress",
    domains: ["Canon", "Voice", "Positioning", "Progression", "Pathway", "Business", "Boundary", "Architecture", "Consent", "Privacy", "Lens", "Expansion"],
    adrCount: 17,
    description:
      "17 ADRs capturing the mission crystallization for YY Method Home Edition: real YY from yyandme.benchantech.com is promoted from mascot/reference to first-class viewpoint; childlike wonder is carried through adult syntax; the product is adult-directed and family-shareable rather than kids-only; badges, XP, quests, and family victories become the learning loop; yyworld becomes the kids' safe sandbox while yymethod-home becomes the graduation field where ideas become doctrine; Ben Chan Tech graduates toward a family-first learning academy; yysworld's code structure becomes the early architecture kernel; and the child-led AI learning ledger is bounded by founder-parent non-coercion, clear upside disclosure, a private-key/public-key architecture, YY safe-distance narration, and personal opt-in expansion.",
    href: "/case-011",
    tags: ["real-yy", "yyandme", "adult-syntax", "childlike-wonder", "family-ai-literacy", "gamification", "badges", "xp", "quests", "yyworld", "graduation-field", "benchantech", "learning-academy", "family-first", "golden-seed", "adaptive-proof", "yysworld-kernel", "architecture", "founder-parent", "non-coercion", "private-key", "public-key", "yy-lens", "safe-distance", "opt-in", "portfolio-proof", "anti-slop", "coppa-posture"],
  },
  {
    id: "case-010",
    number: "010",
