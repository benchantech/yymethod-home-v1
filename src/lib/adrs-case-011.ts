...
export const adrsCase011: ADRCase011[] = [
  {
    ...
    status: "Decided",
    freshness: "Permanent",
    freshnessNote: "Permanent. The system may mature, but the source of YY's authority remains the real YY from yyand.me.",
    date: "2026-06-06",
    domain: "canon",
    position: "Foundational",
    dependsOn: [],
    summary: "Real YY from yyand.me is promoted from mascot/reference to first-class viewpoint for YY Method Home Edition. YY is the emotional operating system and teaching lens: companion, comic interruption, inner-child keeper, and narrative bridge between childhood imagination and adult reasoning. yysworld remains a branch/sandbox lineage; yyand.me remains the canonical emotional source.",
