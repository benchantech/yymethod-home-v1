...
export const adrsCase008: ADRCase008[] = [
  ...
  },
  {
    ...
    summary: "Before the current year's event, the premium square rule was explicitly clarified by the organizers. The fact that this clarification was deemed necessary confirms that the rule was previously ambiguous or inconsistently applied — structurally consistent with the charitable hypothesis that the prior anomalous result arose from accidental misapplication rather than deliberate inflation. The prior result is attributed to accidental misapplication under an unclarified format. The integrity question is resolved. The commitment not to relitigate holds.",
    tags: ["prior-anomaly-resolved", "rule-clarification", "retroactive-evidence", "charitable-hypothesis-confirmed", "case-closed", "integrity"],
  },
  {
    id: "C8-031",
    number: "031",
