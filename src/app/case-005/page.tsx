...
export default function Case005Page() {
  return (
    <main className="flex-1">
      {/* Breadcrumb */}
      <div className="font-mono max-w-[860px] mx-auto px-6 md:px-12 pt-[22px] text-[12.5px]">
        <Link href="/" className="text-[#96683f] hover:text-foreground">← Cases &amp; ADRs</Link>
        <span className="text-[#8a7358]"> / Case #005</span>
      </div>
      ...
      <div className="border-b border-border">
        <div className="max-w-[860px] mx-auto px-6 md:px-12 pt-[30px] pb-[42px]">
          ...
          <p className="mt-4 text-[18px] italic text-[#3f2b16]">The question is closed. It reopens only when reality changes.</p>
        </div>
      </div>
      ...
      <div className="border-b border-border bg-[#eeddc4]">
        <div className="max-w-[860px] mx-auto px-6 md:px-12 pt-9 pb-[42px]">
          <div className="font-mono text-[12px] tracking-[.16em] text-[#96683f] mb-[18px]">
          ...
          return (
            <div key={domain} className="mt-[30px]">
              <div className="flex items-center gap-3.5">
                ...
                <span className="font-mono text-[11.5px] text-[#8a7358]">{range}</span>
              </div>
              <div className="flex flex-col mt-3 bg-[#faf4e8] border border-border">
                {group.map((adr) => {
                  ...
                  return (
                    ...
                    >
                      <span className="font-mono text-[12.5px] text-[#96683f]">{adr.id}</span>
                      <span className="text-[15.5px] leading-[1.45] text-[#3f2b16]">{adr.title}</span>
                      <span className={`font-mono col-start-2 sm:col-start-3 text-[11px] tracking-[.08em] sm:text-right font-semibold ${status.color}`}>
                        {status.label}
                      </span>
                    </Link>
                  );
      ...
      <div className="border-t border-border bg-[#eeddc4]">
        <div className="max-w-[860px] mx-auto grid grid-cols-1 sm:grid-cols-2 px-6 md:px-12">
          <Link href="/case-004" className="py-6 sm:pr-6 border-b sm:border-b-0 sm:border-r border-border">
            <div className="font-mono text-[11.5px] text-[#96683f]">← CASE #004</div>
            <div className="text-[16px] font-semibold mt-1.5 text-[#3f2b16]">
              Local-First Remote Work Orchestration for Sensitive Compute
            </div>
          </Link>
          <Link href="/case-006" className="py-6 sm:pl-6 sm:text-right">
            <div className="font-mono text-[11.5px] text-[#96683f]">CASE #006 →</div>
            <div className="text-[16px] font-semibold mt-1.5 text-[#3f2b16]">
